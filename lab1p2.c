 ...
 * Author: julianyi
 *
 * Created on October 2, 2014, 1:04 PM
 */
...
int main(void)
{
	...
	T1CONbits.TON = 1;
        ...
        IFS0bits.T2IF = 0;
        IEC0bits.T2IE = 1;
        T2CONbits.TCS = 0;      //sets timer 2 to use internal clock (Fosc/2)
        T2CONbits.TON = 0;      //Set Timer 2 to be initially off.
        T2CONbits.TCKPS1 = 0;   //set the prescalar for timer 2 to be 1:1
        T2CONbits.TCKPS0 = 0;
